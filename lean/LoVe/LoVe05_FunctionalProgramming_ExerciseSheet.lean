...
theorem take_drop {α : Type} :
  ...
  | m + 1, x::xs => by simp [take_drop m xs, take, drop]
...
| app f t => "(" ++ Term.repr f ++ " " ++ Term.repr t ++ ")"
